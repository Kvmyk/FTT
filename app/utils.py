...
def get_route(start_lat, start_lon, end_lat, end_lon):
    url = f"http://osrm-foot-opolskie:5000/route/v1/foot/{start_lon},{start_lat};{end_lon},{end_lat}?overview=full&geometries=geojson&steps=true&alternatives=false"
...
def is_hate_speech(text):
    url = "http://relaxed_jemison:5001/analyze"
    headers = {
