...
class Server:
    ...
    <div class="popup-container-{lat}-{lon}" style="width: 300px; max-height:300px; overflow-y: auto;">
        ...
        <script>
            function toggleComments_{lat}_{lon}() {{
                const content = document.getElementById('comments_{lat}_{lon}');
                const btn = document.getElementById('toggleBtn_{lat}_{lon}');
        ...
        <button id="toggleBtn_{lat}_{lon}" 
                class="toggle-btn" 
                onclick="toggleComments_{lat}_{lon}()">
            Pokaż komentarze
        </button>
