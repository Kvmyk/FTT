...
// Dodaj efekt do wszystkich przycisków
function initRippleEffect() {
    const buttons = document.querySelectorAll('.popup-button, .circle-plus, button');
    buttons.forEach(button => {
...
// Reinicjalizacja po aktualizacji mapy
window.addEventListener('map-updated', initRippleEffect);
